...
func main() {
	...
	for _, path := range []string{"install/0000_00_cluster-version-operator_01_clusterversion.crd.yaml", "install/0000_00_cluster-version-operator_01_clusteroperator.crd.yaml"} {
		var name string
