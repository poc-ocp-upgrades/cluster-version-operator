...
func setupCVOTest(payloadDir string) (*Operator, map[string]runtime.Object, *fake.Clientset, *dynamicfake.FakeDynamicClient, func()) {
	...
	o := &Operator{namespace: "test", name: "version", queue: workqueue.NewNamedRateLimitingQueue(workqueue.DefaultControllerRateLimiter(), "cvo-loop-test"), client: client, cvLister: &clientCVLister{client: client}}
	...
	worker := NewSyncWorker(&fakeDirectoryRetriever{Info: PayloadInfo{Directory: payloadDir}}, &testResourceBuilder{client: dynamicClient}, time.Second/2, wait.Backoff{Steps: 1})
	o.configSync = worker
	return o, cvs, client, dynamicClient, func() {
		o.queue.ShutDown()
	}
}
func TestCVO_StartupAndSync(t *testing.T) {
	...
	expectCreate(t, actions[2], "clusterversions", "", &configv1.ClusterVersion{ObjectMeta: metav1.ObjectMeta{Name: "version"}, Spec: configv1.ClusterVersionSpec{ClusterID: actual.Spec.ClusterID, Channel: "fast"}})
	...
	expectGet(t, actions[0], "clusterversions", "", "version")
	actual = cvs["version"].(*configv1.ClusterVersion)
	expectUpdateStatus(t, actions[1], "clusterversions", "", &configv1.ClusterVersion{ObjectMeta: metav1.ObjectMeta{Name: "version", Generation: 1}, Spec: configv1.ClusterVersionSpec{ClusterID: actual.Spec.ClusterID, Channel: "fast"}, Status: configv1.ClusterVersionStatus{History: []configv1.UpdateHistory{}, Conditions: []configv1.ClusterOperatorStatusCondition{{Type: configv1.OperatorAvailable, Status: configv1.ConditionFalse}, {Type: configv1.ClusterStatusConditionType("Failing"), Status: configv1.ConditionTrue, Message: "No configured operator version, unable to update cluster"}, {Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Message: "Unable to apply <unknown>: an error occurred"}, {Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse}}}})
	verifyAllStatus(t, worker.StatusCh())
...
func TestCVO_StartupAndSyncUnverifiedPayload(t *testing.T) {
	...
	defer cancel()
	defer shutdownFn()
	payloadErr := &payload.UpdateError{Reason: "ImageVerificationFailed", Message: fmt.Sprintf("The update cannot be verified: some random error"), Nested: fmt.Errorf("some random error")}
	if !isImageVerificationError(payloadErr) {
		t.Fatal("not the correct error type")
	}
	worker := o.configSync.(*SyncWorker)
	worker.retriever.(*fakeDirectoryRetriever).Info = PayloadInfo{Directory: "testdata/payloadtest", Local: true, VerificationError: payloadErr}
	go worker.Start(ctx, 1)
	client.ClearActions()
	err := o.sync(o.queueKey())
	if err != nil {
...
func TestCVO_UpgradeUnverifiedPayload(t *testing.T) {
	...
	verifyAllStatus(t, worker.StatusCh(), SyncWorkerStatus{Step: "RetrievePayload", Actual: configv1.Update{Version: "1.0.1-abc", Image: "image/image:1"}}, SyncWorkerStatus{Step: "RetrievePayload", Failure: payloadErr, Actual: configv1.Update{Version: "1.0.1-abc", Image: "image/image:1"}})
	client.ClearActions()
	err = o.sync(o.queueKey())
	if err != nil {
		t.Fatal(err)
	...
	expectGet(t, actions[0], "clusterversions", "", "version")
	actual := cvs["version"].(*configv1.ClusterVersion)
	expectUpdateStatus(t, actions[1], "clusterversions", "", &configv1.ClusterVersion{ObjectMeta: metav1.ObjectMeta{Name: "version", ResourceVersion: "1", Generation: 1}, Spec: configv1.ClusterVersionSpec{ClusterID: clusterUID, Channel: "fast", DesiredUpdate: &desired}, Status: configv1.ClusterVersionStatus{Desired: desired, VersionHash: "6GC9TkkG9PA=", History: []configv1.UpdateHistory{{State: configv1.PartialUpdate, Image: "image/image:1", Version: "1.0.1-abc", StartedTime: defaultStartedTime}, {State: configv1.CompletedUpdate, Image: "image/image:0", Version: "1.0.0-abc", Verified: true, StartedTime: defaultStartedTime, CompletionTime: &defaultCompletionTime}}, Conditions: []configv1.ClusterOperatorStatusCondition{{Type: configv1.OperatorAvailable, Status: configv1.ConditionTrue, Message: "Done applying 1.0.0-abc"}, {Type: configv1.ClusterStatusConditionType("Failing"), Status: configv1.ConditionTrue, Reason: "ImageVerificationFailed", Message: "The update cannot be verified: some random error"}, {Type: configv1.OperatorProgressing, Status: configv1.ConditionTrue, Reason: "ImageVerificationFailed", Message: "Unable to apply 1.0.1-abc: the image may not be safe to use"}, {Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse}}}})
	copied := desired
	copied.Force = true
	...
	expectGet(t, actions[0], "clusterversions", "", "version")
	expectUpdateStatus(t, actions[1], "clusterversions", "", &configv1.ClusterVersion{ObjectMeta: metav1.ObjectMeta{Name: "version", ResourceVersion: "1", Generation: 1}, Spec: configv1.ClusterVersionSpec{ClusterID: actual.Spec.ClusterID, Channel: "fast", DesiredUpdate: &copied}, Status: configv1.ClusterVersionStatus{ObservedGeneration: 1, Desired: configv1.Update{Version: "1.0.1-abc", Image: "image/image:1", Force: true}, VersionHash: "6GC9TkkG9PA=", History: []configv1.UpdateHistory{{State: configv1.CompletedUpdate, Image: "image/image:1", Version: "1.0.1-abc", StartedTime: defaultStartedTime, CompletionTime: &defaultCompletionTime}, {State: configv1.CompletedUpdate, Image: "image/image:0", Version: "1.0.0-abc", Verified: true, StartedTime: defaultStartedTime, CompletionTime: &defaultCompletionTime}}, Conditions: []configv1.ClusterOperatorStatusCondition{{Type: configv1.OperatorAvailable, Status: configv1.ConditionTrue, Message: "Done applying 1.0.1-abc"}, {Type: configv1.ClusterStatusConditionType("Failing"), Status: configv1.ConditionFalse}, {Type: configv1.OperatorProgressing, Status: configv1.ConditionFalse, Message: "Cluster version is 1.0.1-abc"}, {Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse}}}})
}
func TestCVO_UpgradeVerifiedPayload(t *testing.T) {
	...
	uid, _ := uuid.NewRandom()
	clusterUID := configv1.ClusterID(uid.String())
	cvs["version"] = &configv1.ClusterVersion{ObjectMeta: metav1.ObjectMeta{Name: "version", ResourceVersion: "1", Generation: 1}, Spec: configv1.ClusterVersionSpec{ClusterID: clusterUID, Channel: "fast", DesiredUpdate: &desired}, Status: configv1.ClusterVersionStatus{Desired: desired, VersionHash: "6GC9TkkG9PA=", History: []configv1.UpdateHistory{{State: configv1.CompletedUpdate, Image: "image/image:0", Version: "1.0.0-abc", Verified: true, StartedTime: defaultStartedTime, CompletionTime: &defaultCompletionTime}}, Conditions: []configv1.ClusterOperatorStatusCondition{{Type: configv1.OperatorAvailable, Status: configv1.ConditionTrue, Message: "Done applying 1.0.0-abc"}, {Type: configv1.ClusterStatusConditionType("Failing"), Status: configv1.ConditionFalse}, {Type: configv1.OperatorProgressing, Status: configv1.ConditionFalse, Message: "Cluster version is 1.0.0-abc"}, {Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse}}}}
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
	defer shutdownFn()
	payloadErr := &payload.UpdateError{Reason: "ImageVerificationFailed", Message: fmt.Sprintf("The update cannot be verified: some random error"), Nested: fmt.Errorf("some random error")}
	...
	verifyAllStatus(t, worker.StatusCh(), SyncWorkerStatus{Step: "RetrievePayload", Actual: configv1.Update{Version: "1.0.1-abc", Image: "image/image:1"}, Generation: 1}, SyncWorkerStatus{Step: "RetrievePayload", Failure: payloadErr, Actual: configv1.Update{Version: "1.0.1-abc", Image: "image/image:1"}, Generation: 1})
	client.ClearActions()
	err = o.sync(o.queueKey())
	if err != nil {
		t.Fatal(err)
...
func TestCVO_ErrorDuringReconcile(t *testing.T) {
	...
	go worker.Start(ctx, 1)
	verifyAllStatus(t, worker.StatusCh(), SyncWorkerStatus{Reconciling: true, Step: "RetrievePayload", Actual: configv1.Update{Version: "1.0.0-abc", Image: "image/image:1"}}, SyncWorkerStatus{Reconciling: true, Step: "ApplyResources", VersionHash: "6GC9TkkG9PA=", Actual: configv1.Update{Version: "1.0.0-abc", Image: "image/image:1"}})
	verifyAllStatus(t, worker.StatusCh())
	client.ClearActions()
	err = o.sync(o.queueKey())
	if err != nil {
	...
	expectGet(t, actions[0], "clusterversions", "", "version")
	b.Send(nil)
	verifyAllStatus(t, worker.StatusCh(), SyncWorkerStatus{Reconciling: true, Fraction: float32(1) / 3, Step: "ApplyResources", VersionHash: "6GC9TkkG9PA=", Actual: configv1.Update{Version: "1.0.0-abc", Image: "image/image:1"}, LastProgress: time.Unix(1, 0)})
	verifyAllStatus(t, worker.StatusCh())
	b.Send(nil)
	verifyAllStatus(t, worker.StatusCh(), SyncWorkerStatus{Reconciling: true, Fraction: float32(2) / 3, Step: "ApplyResources", VersionHash: "6GC9TkkG9PA=", Actual: configv1.Update{Version: "1.0.0-abc", Image: "image/image:1"}, LastProgress: time.Unix(1, 0)})
	verifyAllStatus(t, worker.StatusCh())
	...
	expectGet(t, actions[0], "clusterversions", "", "version")
	expectUpdateStatus(t, actions[1], "clusterversions", "", &configv1.ClusterVersion{ObjectMeta: metav1.ObjectMeta{Name: "version", ResourceVersion: "1"}, Spec: configv1.ClusterVersionSpec{ClusterID: clusterUID, Channel: "fast"}, Status: configv1.ClusterVersionStatus{Desired: configv1.Update{Version: "1.0.0-abc", Image: "image/image:1"}, VersionHash: "6GC9TkkG9PA=", History: []configv1.UpdateHistory{{State: configv1.CompletedUpdate, Image: "image/image:1", Version: "1.0.0-abc", Verified: true, StartedTime: defaultStartedTime, CompletionTime: &defaultCompletionTime}}, Conditions: []configv1.ClusterOperatorStatusCondition{{Type: configv1.OperatorAvailable, Status: configv1.ConditionTrue, Message: "Done applying 1.0.0-abc"}, {Type: configv1.ClusterStatusConditionType("Failing"), Status: configv1.ConditionTrue, Reason: "UpdatePayloadFailed", Message: "Could not update test \"file-yml\" (3 of 3)"}, {Type: configv1.OperatorProgressing, Status: configv1.ConditionFalse, Reason: "UpdatePayloadFailed", Message: "Error while reconciling 1.0.0-abc: the update could not be applied"}, {Type: configv1.RetrievedUpdates, Status: configv1.ConditionFalse}}}})
}
func TestCVO_ParallelError(t *testing.T) {
	...
	defer shutdownFn()
	worker := o.configSync.(*SyncWorker)
	b := &errorResourceBuilder{errors: map[string]error{"0000_10_a_file.yaml": &payload.UpdateError{Reason: "ClusterOperatorNotAvailable", Name: "operator-1"}, "0000_20_a_file.yaml": nil, "0000_20_b_file.yaml": &payload.UpdateError{Reason: "ClusterOperatorNotAvailable", Name: "operator-2"}}}
	worker.builder = b
	o.releaseImage = "image/image:1"
	o.releaseVersion = "1.0.0-abc"
	desired := configv1.Update{Version: "1.0.0-abc", Image: "image/image:1"}
	uid, _ := uuid.NewRandom()
	clusterUID := configv1.ClusterID(uid.String())
	cvs["version"] = &configv1.ClusterVersion{ObjectMeta: metav1.ObjectMeta{Name: "version", ResourceVersion: "1"}, Spec: configv1.ClusterVersionSpec{ClusterID: clusterUID, Channel: "fast"}, Status: configv1.ClusterVersionStatus{Desired: desired, History: []configv1.UpdateHistory{}, Conditions: []configv1.ClusterOperatorStatusCondition{}}}
	client.ClearActions()
	err := o.sync(o.queueKey())
	if err != nil {
		t.Fatal(err)
	...
	verifyAllStatus(t, worker.StatusCh(), SyncWorkerStatus{Initial: true, Step: "RetrievePayload", Actual: configv1.Update{Version: "1.0.0-abc", Image: "image/image:1"}}, SyncWorkerStatus{Initial: true, Step: "ApplyResources", VersionHash: "7m-gGRrpkDU=", Actual: configv1.Update{Version: "1.0.0-abc", Image: "image/image:1"}})
	time.Sleep(100 * time.Millisecond)
	cancel()
	for status := range worker.StatusCh() {
		if status.Failure == nil {
			if status.Fraction == 0 || status.Fraction == 1/3 {
				if !reflect.DeepEqual(status, SyncWorkerStatus{Initial: true, Fraction: status.Fraction, Step: "ApplyResources", VersionHash: "7m-gGRrpkDU=", Actual: configv1.Update{Version: "1.0.0-abc", Image: "image/image:1"}}) {
		...
		if !reflect.DeepEqual(status, SyncWorkerStatus{Initial: true, Failure: err, Fraction: float32(1) / 3, Step: "ApplyResources", VersionHash: "7m-gGRrpkDU=", Actual: configv1.Update{Version: "1.0.0-abc", Image: "image/image:1"}, LastProgress: status.LastProgress}) {
...
type blockingResourceBuilder struct{ ch chan error }
