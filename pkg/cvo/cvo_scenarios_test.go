...
func setupCVOTest(payloadDir string) (*Operator, map[string]runtime.Object, *fake.Clientset, *dynamicfake.FakeDynamicClient, func()) {
	...
	worker := NewSyncWorker(&fakeDirectoryRetriever{Path: payloadDir}, &testResourceBuilder{client: dynamicClient}, time.Second/2, wait.Backoff{Steps: 1})
	o.configSync = worker
